                ...
                <div className="grid grid-cols-3 gap-4 gap-y-12">
                    {artists.map((artist, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-lg font-medium text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde voluptate laudantium aliquid porro doloremque doloribus nam perspiciatis ea deleniti nesciunt!</h3>
                        </div>
                    ))}
                </div>
            </div>
