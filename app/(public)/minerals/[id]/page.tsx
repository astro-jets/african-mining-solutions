...
const SingleMineralPage = async ({ params }: { params: Params }) => {
    const id = params.id;
    const mineral: Company = await fetchMineralById(id)
            ...
            {mineral &&
                ...
                >
                    <div className="flex flex-col w-4/5 items-center justify-center">
                        ...
                        <p className="text-5xl text-center text-black font-bold my-4">{mineral.name}</p>
                        ...
                        <h3 className="text-lg font-medium text-black my-8 ">{mineral.description}</h3>
                    </div>
                    ...
                    <div className="flex flex-col max-w-full w-full h-full">
                        ...
                        <div className="w-full h-[80vh]">
                            <DynamicMap center={[
                                parseInt(mineral.coordinates[0]),
                                parseInt(mineral.coordinates[1])
                            ]}
                                zoom={15} />
                        </div>
...
export default SingleMineralPage;