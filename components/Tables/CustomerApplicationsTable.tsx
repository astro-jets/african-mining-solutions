...
const ApplicationsTable = ({ applications }: { applications: Application[] }) => {
  ...
  const downloadPDF = (applications: any) => {
    alert("Saving Report")
    const doc = new jsPDF();
    ...
    autoTable(doc, {
      ...
      body: applications as RowInput[],
    });
    doc.save('applications-applications.pdf');
    console.log("Doc => ", doc)
  };
              ...
              <tr key={key}>
                ...
                {/* <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <Link href={`/dashboard/applications/${application._id}`} className="hover:text-primary">
                      <svg
